...
- [ ] Criar função que verifica se o evento Lead já foi disparado pelo usuário atual (compatível com evento Lead do Meta)
...
- [ ] Confirmar que o evento é disparado logo após o evento Lead, mesmo timing do SubmitApplication no Meta
- [ ] Verificar se event_params inclui:
 - [ ] value calculado pelo lead scoring (mesmo valor do evento Lead e do Meta)
 - [ ] currency_code (mesmo do evento Lead e do Meta)
...
- [ ] Confirmar que o evento é disparado logo após o evento Lead quando a página carrega (mesmo do Meta)
- [ ] Validar se o value está sendo enviado de forma consistente com o evento Lead e com o Meta
...
- [ ] Garantir que o evento sign_up também é disparado para o formulário de apresentação quando o lead é qualificado## 7. Evento Lead (Equivalente ao Lead do Meta)


### Measurement Protocol:


- [ ] Confirmar que o Measurement Protocol de Lead é disparado em paralelo à CAPI de Lead
- [ ] Verificar se o evento Lead é disparado para TODOS os leads que submeteram formulários, mesmo timing do Meta
...
- [ ] Verificar se o sistema de deduplicação previne múltiplos envios em sincronia com o Meta
- [ ] Assegurar que o formulário de apresentação também dispare corretamente o evento Lead junto com Lead do Meta
...
- [ ] Garantir que o evento Lead é disparado para o formulário de apresentação com os mesmos critérios do Meta## 6. Evento contact (Equivalente ao Contact do Meta)
...
- [ ] Confirmar que o evento VerApresentacao é independente e não substitui os eventos Lead e QualifiedLead
...
- [ ] Garantir que o evento VerApresentacao é tratado como um evento distinto dos eventos Lead e QualifiedLead
