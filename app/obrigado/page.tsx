...
export const metadata: Metadata = {
  title: "Obrigado por agendar sua reunião - VFX Agência",
...
export default function ThankYouPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      {/* Componente client para rastreamento de PageView */}
      <ClientPageView />
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg">Em breve um especialista entrará em contato para agendar sua reunião.</p>
        </div>

        {/* Video and Steps Section - Updated layout for horizontal video */}
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4">Assista nossa mensagem especial:</h2>
            <ThankYouVideo />
          </div>
              ...
              {[
                {
                  ...
                  description: "Em até 5 minutos, um consultor de nosso time entrará em contato com você via Whatsapp.",
                  icon: "📞",
                },
                {
                  title: "Prepare suas dúvidas",
                  description: "Anote todas as suas dúvidas e objetivos para otimizarmos nossa reunião.",
                  icon: "📝",
                },
                {
                ...
                },
                {
                  ...
                  description: "Convide as pessoas-chave da sua empresa para participar da reunião estratégica.",
                  icon: "👥",
                },
              ].map((step, index) => (
